...
function Footer() {
    return (
     ...
     <div className='px-96  ' id='Footer'>
        ...
        <div className='w-full flex gap-4  justify-between bg-slate-400 dark:bg-slate-600   p-10 rounded-lg mt-10 '>
      ...
      <div className='flex justify-between items-center mt-4  pb-20 px-96 text-slate-950 dark:text-slate-100'>
