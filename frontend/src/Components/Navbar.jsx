...
{gettoken() ? <div className="flex gap-4 font-bold justify-center items-center px-5">
        ...
        </div>:  <div className="flex gap-4 font-bold justify-center items-center px-5">
          ...
          <div className="cursor-pointer border px-2 py-1 rounded-lg bg-slate-400 text-white text-xl " onClick={()=>{setCurrState("Sign up");setShowLogin(true)}}>Signup</div>
        </div>}
