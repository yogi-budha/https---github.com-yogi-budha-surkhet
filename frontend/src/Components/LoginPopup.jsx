...
function LoginPopup({setShowLogin,currState,setCurrState}) {
  ...
  <div className="flex justify-center items-center mt-28">
    <div className="w-full max-w-md bg-slate-400 px-5 py-5 flex flex-col gap-5 rounded-md">
      ...
      <button className="text-white bg-red-500 px-2 py-1 rounded-lg text-lg font-bold" onClick={submitHandler}>
