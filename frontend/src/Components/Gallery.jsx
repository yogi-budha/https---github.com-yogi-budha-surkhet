...
function Gallery() {
  ...
  return (
    ...
    <div className='w-full md:w-[70%]'>
      ...
      <div className='w-full flex justify-between mb-3 dark:text-slate-100 flex-wrap'>
  
        {categoryBy.map((category, i) => (
          <p key={i} onClick={() => categoryFilter(category)} className='cursor-pointer font-semibold border border-slate-500 px-2 py-1 rounded-full hover:text-slate-500 hover:border-slate-400'>
            {category}
          </p>
        ))}
